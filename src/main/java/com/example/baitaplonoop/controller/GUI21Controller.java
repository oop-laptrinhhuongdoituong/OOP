                ...
                for (int i = 0; i < questionsList.size(); i++) {
                    ...
                    questionsList.get(i).getButton().setOnAction(event1 -> {
                        ...
                        try {
                            ...
                            gui32Controller.editingQuestionChoice(Default.getText(), questionsList.get(k).getQuestionID(), editQuestionText, choiceInfo1[0], choiceInfo1[1], choiceInfo1[2], choiceInfo2[0], choiceInfo2[1], choiceInfo2[2], choiceInfo3[0], choiceInfo3[1], choiceInfo3[2], choiceInfo4[0], choiceInfo4[1], choiceInfo4[2], choiceInfo5[0], choiceInfo5[1], choiceInfo5[2], choiceInfo6[0], choiceInfo6[1], choiceInfo6[2]);
